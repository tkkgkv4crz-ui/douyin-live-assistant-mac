    ...
    <div className="max-w-lg space-y-6">
      ...
      <div className="space-y-4">
        ...
        <div className="p-4 rounded-xl bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700 space-y-3">
          ...
          <input type="range" min={100} max={2000} step={100} value={settings.maxDanmakuCount} onChange={(e) => updateSettings({ maxDanmakuCount: parseInt(e.target.value) })} className="w-full accent-red-500" />
        ...
        <div className="p-4 rounded-xl bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-700 space-y-3">
          ...
          <input type="range" min={10} max={24} step={1} value={settings.danmakuFontSize} onChange={(e) => updateSettings({ danmakuFontSize: parseInt(e.target.value) })} className="w-full accent-red-500" />
